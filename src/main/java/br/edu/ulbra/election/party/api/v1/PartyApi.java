...
public class PartyApi {
    ...
    public List<PartyOutput> getAll(){ return partyService.getAll(); }
    ...
    public PartyOutput create(@RequestBody PartyInput partyInput){ return partyService.create(partyInput); }
    ...
    public GenericOutput delete(@PathVariable Long partyId){ return partyService.delete(partyId); }
}
